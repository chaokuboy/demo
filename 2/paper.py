...
with st.sidebar:
   ...
   placeholder="请选择题目的用途",label_visibility="collapsed",)
    st.write('你选择的是:', "<h4 style='color: red;'>"+str(option)+"</h4>",unsafe_allow_html=True)
    if option=="试卷":
    ...
    if option=="作业":
        st.markdown("<h4 style='color: red;'>选择时间</h4>",unsafe_allow_html=True)
...
bns=1
with st.container():
    st.write("<h4 style='color: red;'>选择题</h4>",unsafe_allow_html=True)
    ...
    st.write("<h6 style='color: red;'>填空题</h6>",unsafe_allow_html=True)
    ...
    st.write("<h6 style='color: red;'>简答题</h6>",unsafe_allow_html=True)
